                                ...
                                <tr>
                                    ...
                                    @role('super-admin')
                                        <td>
                                            ...
                                            <a href="{{route('estudiantes.edit', $estudiante->id)}}"  class="link-warning editIcon"><i
                                                    class="ri-edit-2-fill"></i></a>
                                            <a href="{{route('estudiantes.show', $estudiante->id)}}" class="link-danger"><i class="ri-delete-bin-5-line"></i></a>
                                        </td>
                                    @endrole
                                </tr>
                            @endforeach
